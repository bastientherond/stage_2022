...
class UtilisateurController extends AbstractController
{
    ...
    /**
     * @Route("/{iduser}", name="utilisateur_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{iduser}/edit", name="utilisateur_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{iduser}", name="utilisateur_delete", methods={"POST"})
     */
